namespace Rafat.Gui.BookThanksGui
{
    partial class AddBookThankForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            dateTimePickerdate.Size = new Size(319, 30);
            ...
            numericUpDownEffect.Size = new Size(324, 30);
            numericUpDownEffect.TabIndex = 0;
            numericUpDownEffect.Value = new decimal(new int[] { 30, 0, 0, 0 });
            numericUpDownEffect.ValueChanged += numericUpDownEffect_ValueChanged;
            // 
            // label6
            // 
            ...
            textBoxRef.Size = new Size(324, 30);
            textBoxRef.TabIndex = 1;
            textBoxRef.TextAlign = HorizontalAlignment.Center;
            textBoxRef.TextChanged += textBoxRef_TextChanged;
            // 
            // label4
            // 
