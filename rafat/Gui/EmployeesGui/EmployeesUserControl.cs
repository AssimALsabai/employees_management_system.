...
namespace Rafat.Gui.EmployeesGui
{
    public partial class EmployeesUserControl : UserControl
    {
        ...
        private IDataHelper<Core.Employees> dataHelper;
        private List<Core.Employees> data;
        private List<int> IdDeleteList;
        public EmployeesUserControl()
        {
            InitializeComponent();
            dataHelper = new EmployeesEF();
            data = new List<Core.Employees>();
        ...
        {
            // Get Data
            var data = (List<Core.Employees>)dataGridView1.DataSource;
            ExportExcel(data);

        }

        private void ExportExcel(List<Core.Employees> data)
        {
            // Define Data Table
        ...
        private void labelNofOfItmes_Click(object sender, EventArgs e)
        {
